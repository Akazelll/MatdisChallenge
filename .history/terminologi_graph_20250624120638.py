...
class VisualisasiGraf:
    ...
    Versi ini memiliki visualisasi yang disempurnakan untuk SISI GANDA.
    """
    def __init__(self):
        self.simpul = []
        self.derajat = {}
    ...
    def _visualisasikan(self, judul="Visualisasi Graf"):
        """
        Metode visualisasi yang disempurnakan.
        Sisi ganda akan digambar sebagai busur terpisah agar jelas terlihat.
        """
