...
def buat_graf_manual():
    """
    Membuat sebuah graf (MultiGraph) secara interaktif berdasarkan input pengguna.
    """
    # Menggunakan MultiGraph agar bisa menampung sisi ganda dan loop. 
    G = nx.MultiGraph()
...
def gambar_graf(G):
    ...
    # Menentukan posisi simpul agar visualisasinya baik
