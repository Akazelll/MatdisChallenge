...
class VisualisasiGraf:
    ...
    mengikuti logika dari flowchart yang diberikan.
    """
    def __init__(self):
    ...
    def _jalur_tanpa_syarat(self):
        """Logika untuk membuat graf tanpa syarat (jalur kiri flowchart)."""
    ...
    def _jalur_dengan_syarat(self):
        """Logika untuk membuat graf dengan syarat (jalur kanan flowchart)."""
        ...
        # Buat graf sederhana dari sisa derajat
    ...
    def jalankan(self):
        """Metode utama untuk menjalankan keseluruhan proses."""
        # Start
