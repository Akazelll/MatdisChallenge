...
def buat_graf_dari_derajat(derajat_simpul: Dict[int, int]) -> nx.MultiGraph:
    ...
    Args:
        derajat_simpul (Dict[int, int]): Dictionary berisi simpul dan derajatnya.
    ...
    # Contoh: jika simpul 1 memiliki derajat 3, maka angka 1 akan
    # ditambahkan 3 kali ke dalam daftar.
    daftar_stub = []
