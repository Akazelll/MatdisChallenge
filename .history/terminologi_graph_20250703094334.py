...
class VisualisasiGraf:
    ...
    def _buat_dan_visualisasikan_graf(self):
        """
        Membuat graf dari barisan derajat dengan aturan:
        Tidak boleh ada lebih dari 2 sisi yang menghubungkan pasangan simpul manapun.
        Menggunakan metode 'coba-dan-ulangi' untuk menjamin hasil yang valid.
        """
        print("\n⚙️ Memulai pembuatan graf dengan aturan 'Maksimal 2 Sisi'...")
