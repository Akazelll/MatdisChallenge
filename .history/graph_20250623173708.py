...
import pprint # Digunakan untuk mencetak output agar lebih rapi

# 1. Mendefinisikan struktur data untuk Graf menggunakan namedtuple.
#    Struktur ini akan menyimpan simpul (nodes), sisi (edges), 
#    dan penanda apakah graf tersebut berarah (is_directed).
